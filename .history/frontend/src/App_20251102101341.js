...
// --- A beautiful, free background image from Unsplash ---
const beautifulSkyImage = "https://images.unsplash.com/photo-1499956627063-2489f7c02b6b?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3";

// --- New, more beautiful styles ---
const styles = {
  // The main container, now with a background image
  container: {
    display: 'flex',
    ...
    padding: '20px',
    minHeight: '100vh',
    backgroundImage: `url(${beautifulSkyImage})`,
  ...
  input: {
    ...
    backgroundColor: 'rgba(255, 255, 255, 0.5)', // Slightly translucent input
  },
  button: {
    padding: '14px',
    fontSize: '1.1rem',
