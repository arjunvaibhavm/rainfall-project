...
const styles = {
  ...
  header: {
    fontSize: '2.5rem',
    fontWeight: 'bold',
    color: '#f6e05e', // --- CHANGED: Nimbus Golden Color ---
    textAlign: 'center',
  ...
  button: {
    padding: '14px',
    fontSize: '1.1rem',
    color: '#1a202c', // --- CHANGED: Dark text ---
    backgroundColor: '#f6e05e', // --- CHANGED: Nimbus Golden Color ---
    border: 'none',
    borderRadius: '10px',
    cursor: 'pointer',
    marginTop: '20px',
    ...
    boxShadow: '0 5px 15px rgba(246, 224, 94, 0.4)', // --- ADDED: Golden shadow ---
  },
  resultsContainer: {
    marginTop: '30px',
    width: '100%',
  ...
  scoutContainer: {
    ...
    marginBottom: '15px',
    border: '2px solid #f6e05e', // --- CHANGED: Nimbus Golden Color ---
    boxShadow: '0 4px 20px 0 rgba(246, 224, 94, 0.15)', // --- CHANGED: Golden shadow ---
  },
  scoutTitle: {
    fontSize: '1.2rem',
    fontWeight: 'bold',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.glassContainer}>
        <h1 style={styles.header}>NIMBUS</h1>
