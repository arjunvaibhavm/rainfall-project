...
const styles = {
  ...
  glassContainer: {
    ...
    flexDirection: 'column',
    width: '100%',
    // maxWidth: '600px', // <-- REMOVED
    backgroundColor: 'rgba(45, 55, 72, 0.8)', 
    padding: '30px',
    // borderRadius: '20px', // <-- REMOVED
    // boxShadow: '0 8px 32px 0 rgba(0, 0, 0, 0.3)', // <-- REMOVED
    // backdropFilter: 'blur(5px)', // <-- REMOVED
    // border: '1px solid rgba(255, 255, 255, 0.18)', // <-- REMOVED
    // marginTop: '20px', // <-- REMOVED
    boxSizing: 'border-box',
  },
  header: {
    fontSize: '2.5rem',
