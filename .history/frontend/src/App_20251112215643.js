...
function App() {
  ...
  // --- REMOVED: No longer need compareLocations state ---
  ...
  // For example: 'https://rainfall-api.onrender.com/predict'
  ...
  const handleSubmit = (e) => {
    ...
    const dataToSend = { 
      city: location,
      activity: activity,
      // --- REMOVED: No longer need to send this ---
    ...
    <div style={styles.container}>
      <div style={styles.glassContainer}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          {/* --- REMOVED: Compare Locations Input --- */}
              ...
              {predictionData.location_ranking && (
                <div style={styles.scoutContainer}>
                  ...
                  {predictionData.location_ranking.map((item, index) => {
                    ...
                    else if (item.score === 1) { recStyle.color = '#f6e056'; } // Yellow
