...
// --- Styles with a new "Desktop Dark" Theme ---
const styles = {
  container: {
    display: 'flex',
  ...
  glassContainer: {
    ...
    flexDirection: 'column',
    width: '100%',
    // Made wider for a desktop feel
    maxWidth: '500px', 
    // Dark translucent background
    backgroundColor: 'rgba(40, 40, 40, 0.75)', 
    padding: '30px',
    borderRadius: '15px', // Slightly sharper corners
  ...
  resultBox: {
    // Darker, subtle background for results
  ...
  error: {
    ...
    fontSize: '1.2rem',
    fontWeight: 'bold',
    color: '#ffc0cb', // Light pink for error text
    textAlign: 'center',
