...
import logoSrc from './nimbus-logo.png'; // Make sure this filename is correct
...
const styles = {
  container: {
    ...
    // --- MOVED from glassContainer ---
    // We still want a max width for large screens
    maxWidth: '1200px',
    margin: '0 auto', // Center the container
  },
  // --- REMOVED: glassContainer style ---
  ...
  form: {
    ...
    flexDirection: 'column',
    width: '100%',
    marginTop: '30px', // Add space below header
  },
  formGroup: {
    display: 'flex',
    flexDirection: 'column',
  ...
  resultBox: {
    // --- UPDATED: A slightly lighter shade of the main bg ---
    backgroundColor: 'rgba(45, 55, 72, 0.5)', // Dark Glass
    padding: '20px',
    borderRadius: '15px',
    // boxShadow: '0 4px 12px rgba(0,0,0,0.1)', // Not needed without card
    marginBottom: '15px',
