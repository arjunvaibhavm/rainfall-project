...
const styles = {
  container: {
    ...
    fontFamily: '-apple-system, BlinkMacSyimport React from 'react';
// --- IMPORT YOUR LOGO DIRECTLY ---
// Make sure your .jpg file is in the frontend/src/ folder
import logoSrc from './Gemini_Generated_Image_7sb4io7sb4io7sb4.jpg'; 
...
export default WelcomePage;stemFont, "Segoe UI", Roboto, "Inter", Arial, sans-serif',
    textAlign: 'center',
    padding: '20px',
    animation: 'fadeIn 1.5s ease-out',
  },
