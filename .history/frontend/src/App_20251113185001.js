...
// Make sure this filename (nimbus-logo.png) is correct!
import logoSrc from './Gemini_Generated_Image_7sb4io7sb4io7sb4.png'; 

// --- Styles for Desktop Dark Theme ---
const styles = {
  // This container fills the whole screen and centers the card
  container: {
    display: 'flex',
    ...
    padding: '20px',
    minHeight: '100vh',
    // The background image is now on index.css
    width: '100%',
    boxSizing: 'border-box',
  },
  // --- This is the glass card ---
  glassContainer: {
    display: 'flex',
    flexDirection: 'column',
    width: '100%',
  ...
  headerLogo: {
    ...
    marginRight: '15px',
    // No mix-blend-mode needed for a PNG
  },
  form: {
    display: 'flex',
    flexDirection: 'column',
  ...
  gridContainer: {
    display: 'grid',
    // --- UPDATED: Grid size for the 2x2 data boxes ---
  ...
  mlResultValue: {
    // --- UPDATED: Matched to recommendationValue size ---
    fontSize: '2rem', 
    fontWeight: 'bold',
    color: '#f6e05e', // Nimbus Golden Color
    marginTop: '5px',
    lineHeight: '1.4', // Add line height for longer sentences
  },
  impactResultValue: {
    fontSize: '1.2rem',
    fontWeight: 'bold',
      ...
      <div style={styles.glassContainer}>
        ...
        <div style={styles.resultsContainer}>
          ...
          {!isLoading && predictionData && (
            // --- UPDATED: The <div> for the grid is now *after* the big boxes ---
            <>
              {/* --- Location Scout Results (Full Width) --- */}
              ...
              {/* --- NEW: ML Confidence (Full Width) --- */}
              <div style={{
                  ...styles.resultBox, 
                  ...styles.fullWidthItem, // <-- ADDED THIS
                  border: '2px solid #f6e05e', // Nimbus Golden Color
                  boxShadow: '0 4px 20px 0 rgba(246, 224, 94, 0.15)' // Golden shadow
                }}>
              ...
              {/* --- This grid now contains the 4 smaller data boxes --- */}
