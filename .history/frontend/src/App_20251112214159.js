...
const styles = {
  ...
  gridContainer: {
    display: 'grid',
    gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', // More flexible grid
    gap: '15px',
    width: '100%',
  },
  fullWidthItem: {
  ...
  // --- REMOVED 24-Hour Planner Styles ---
  ...
  scoutContainer: {
    ...
    marginBottom: '15px',
    border: '2px solid #63b3ed', // Blue highlight
    boxShadow: '0 4px 20px 0 rgba(99, 179, 237, 0.15)',
  },
  scoutTitle: {
    fontSize: '1.2rem',
    fontWeight: 'bold',
  ...
  scoutHours: { // Renamed, but style is the same
    fontSize: '1.2rem',
    fontWeight: 'bold',
    color: '#63b3ed', // Blue
  },
...
function App() {
  ...
  const [compareLocations, setCompareLocations] = useState('Pune, Lonavala');
  ...
  return (
    <div style={styles.container}>
      <div style={styles.glassContainer}>
        <h1 style={styles.header}>Rain Predictor & Activity Scout</h1>
        
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.formGroup}>
            <label style={styles.label}>Enter Anchor City:</label>
            <input
              type="text"
              name="location"
              value={location}
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>Compare Nearby Locations (comma-separated):</label>
            <input
              type="text"
              name="compare_locations"
              value={compareLocations}
              onChange={(e) => setCompareLocations(e.target.value)}
              style={styles.input}
            ...
            <div style={styles.gridContainer}>
              ...
              {predictionData.location_ranking && (
                <div style={styles.scoutContainer}>
                  <h3 style={styles.scoutTitle}>🏆 Location Scout Results (Next 3 Hrs for {activity})</h3>
              ...
              <div style={{
                ...
                <div style={styles.resultTitle}>🎯 ACTIVITY ADVICE (Next 3 Hours)</div>
                <div style={styles.recommendationValue}>
                  {predictionData.activity_recommendation}
                </div>
              </div>
              
              {/* --- Box 1: Intensity (Half Width) --- */}
              ...
              {/* --- REMOVED 24-Hour Activity Planner --- */}
