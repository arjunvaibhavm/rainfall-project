...
// --- NEW: Import your .png logo ---
// I am ASSUMING you named it 'nimbus-logo.png'
// If not, change the filename here.
...
const styles = {
  ...
  headerLogo: {
    height: '50px',
    width: '50px',
    objectFit: 'contain', // Use 'contain' for PNG
    // --- REMOVED: mixBlendMode ---
    marginRight: '15px',
    // borderRadius: '8px', // Not needed for transparent PNG
  },
  form: {
    display: 'flex',
    flexDirection: 'column',
  ...
  return (
    <div style={styles.container}>
      <div style={styles.glassContainer}>
        {/* --- UPDATED: Header now includes logo --- */}
