...
# SET THIS IN YOUR TERMINAL: export OPENWEATHER_API_KEY="your_actual_key"
WEATHER_API_KEY = os.environ.get("b26abbbb1641a44c12cfa7c7a78c3fd1")

if not WEATHER_API_KEY:
    print("Warning: OPENWEATHER_API_KEY environment variable not set.")
    # You can set a default here for testing, but environment variables are safer
    # WEATHER_API_KEY = "your_default_key_if_you_must" 
